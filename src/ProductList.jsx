...
function ProductList({ onHomeClick }) {
    ...
    },
    {
      ...
      plants: [
        ...
        },
        {
          ...
          description: "Insect-repelling properties while adding a pleasant scent.",
          cost: "$20"
        },
        {
          name: "Basil",
  ...
  const handleAddToCart = (plant) => {
    // 👉 exatamente como no hint:
    dispatch(addItem({
      name: plant.name,
      image: plant.image,
      cost: plant.cost, // string com "$", compatível com seu CartItem atual
      // quantity: 1, // opcional; o slice pode definir 1 como padrão
      // id: `${plant.name}-${plant.image}` // opcional, para evitar colisões por name
    }));
    ...
    // abrir o carrinho após adicionar (opcional):
    setShowCart(true);
  };
